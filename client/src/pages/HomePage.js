    ...
    return (
      <div>
        <section id='banner'>
          ...
          <ul class='actions'>
            <li>
              <a href='#' class='button big'>建立問卷</a>
            </li>
          </ul>
        </section>
          ...
          <div class='container'>
            ...
            <div class='row 150%'>
              <div class='4u 12u$(medium)'>
                <section class='box'>
                  <i class='icon big rounded color1 fa-cloud' />
              ...
              <div class='4u 12u$(medium)'>
                <section class='box'>
                  <i class='icon big rounded color9 fa-desktop' />
              ...
              <div class='4u$ 12u$(medium)'>
                <section class='box'>
                  <i class='icon big rounded color6 fa-rocket' />
